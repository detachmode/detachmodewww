...
/* predefined effects */
Sliderman.effect({name: 'fade', fade: true, duration: 1200});
Sliderman.effect({name: 'move', left: true, move: true, duration: 400});
Sliderman.effect({name: 'stairs', cols: 7, rows: 5, delay: 30, order: 'straight_stairs', road: 'BL', fade: true});
Sliderman.effect({name: 'blinds', cols: 20, delay: 10, duration: 500, order: 'straight', right: true, zoom: true, fade: true});
Sliderman.effect({name: 'rain', cols: 16, delay: 60, duration: 400, order: 'straight', top: true, fade: true});
